    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <strong><?php echo session()->get('admin_username') ?></strong>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light"><strong>BBPBL</strong></span>
            </a>
            ...
            <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item <?php if (in_array($activeMenu, ['mahasiswa'])) echo "menu-open" ?>">
                        <a href="<?= base_url('mahasiswa') ?>" class="nav-link <?php if (in_array($activeMenu, ['mahasiswa'])) echo "active" ?>">
                    ...
                    <li class="nav-header">INSTANSI</li>
                    <li class="nav-item">
                        <a href="pages/calendar.html" class="nav-link">
                            <i class="nav-icon far fa-calendar-alt"></i>
                            <p>
